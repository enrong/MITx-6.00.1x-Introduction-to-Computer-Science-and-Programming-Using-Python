...
def playGame(wordList):
    ...
    count = 0 
    while playOption != 'e':
        playOption = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
        playerOption = 'u'
        print
        if playOption == 'n':
            count += 1
            ...
            rehand =hand.copy()
            while True:
                playerOption = raw_input('Enter u to have yourself play, c to have the computer play: ')
                print
                if playerOption == 'c':
                    compPlayHand(rehand ,wordList, n)
                    break
                elif playerOption == 'u':
                    playHand(rehand , wordList, n)
                    break
                elif True:
